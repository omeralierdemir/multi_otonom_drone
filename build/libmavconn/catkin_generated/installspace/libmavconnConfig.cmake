...
if(NOT "include;/usr/include;/home/efl4tun/catkin_ws/devel/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include;/home/efl4tun/catkin_ws/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/efl4tun/catkin_ws/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/efl4tun/catkin_ws/install/lib;/home/efl4tun/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
