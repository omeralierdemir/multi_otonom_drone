...
if("TRUE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /home/efl4tun/catkin_ws/src/mavros/libmavconn)
  set(libmavconn_DEVEL_PREFIX /home/efl4tun/catkin_ws/devel/.private/libmavconn)
  ...
  set(libmavconn_INSTALL_PREFIX /home/efl4tun/catkin_ws/install)
...
if(NOT "/home/efl4tun/catkin_ws/src/mavros/libmavconn/include;/usr/include;/home/efl4tun/catkin_ws/devel/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/efl4tun/catkin_ws/src/mavros/libmavconn/include;/usr/include;/home/efl4tun/catkin_ws/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/efl4tun/catkin_ws/src/mavros/libmavconn/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/efl4tun/catkin_ws/devel/.private/libmavconn/lib;/home/efl4tun/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
